...
export const metadata = {
  title: "Cookies | Despacho María Lara Molina",
  alternates: { canonical: "https://www.abogadamarialaramolina.com/cookies" },
};
  ...
  return (
    <main>
      <section
        style={{
          backgroundImage:
            "linear-gradient(180deg, rgba(48,25,52,.55), rgba(48,25,52,.55)), url('/bg-cookies.webp')",
