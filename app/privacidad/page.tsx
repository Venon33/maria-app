...
export const metadata = {
  title: "Privacidad | Despacho María Lara Molina",
  alternates: { canonical: "https://www.abogadamarialaramolina.com/privacidad" },
};
  ...
  return (
    <main>
      <section
        style={{
          backgroundImage:
            "linear-gradient(180deg, rgba(4,68,114,.6), rgba(4,68,114,.6)), url('/bg-privacidad.webp')",
